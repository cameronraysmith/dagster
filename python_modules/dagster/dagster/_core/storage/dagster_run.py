...
class DagsterRun(
    ...
    def get_resolved_partitions_subset_for_events(
        ...
        """Get the partitions subset targeted by a run based on its partition tags. Does not use the
        partition_subset that is sometimes stored on the run as this can contain a KeyRangesPartitionSubset
